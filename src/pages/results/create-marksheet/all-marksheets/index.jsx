...
import AllMarksheetSearchForm from "./AllMarksheetSrarchForm/AllMarksheetSearchForm";
import AllMarksheetTable from "./AllMarksheetTable/AllMarksheetTable";

const AllMarksheetsPage = () => {
  return (
    <div className='w-11/12 mx-auto mt-10 pb-32'>
      ...
      <AllMarksheetSearchForm />
      <AllMarksheetTable />
    </div>
  );
};

export default AllMarksheetsPage;
