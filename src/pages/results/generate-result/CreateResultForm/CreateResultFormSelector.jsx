...
export default function CreateResultFormSelector() {
                ...
                <Listbox.Option
                  ...
                  className={({ active }) =>
                    `relative cursor-default select-none py-2 pl-10 pr-4 ${
                      active ? "bg-primary/50 text-gary-900" : "text-gray-900"
                    }`
                  }
                  value={person}>
                  {({ selected }) => (
