...
import ClassRoutineSearchFormSelector from "./ClassRoutineSearchFormSelector";

const ClassRoutineSearchForm = () => {
  return (
    <div className='w-full mx-auto py-5 px-3 bg-white border border-[#0D153026] rounded-2xl'>
      <form>
        <div className='flex justify-center items-center gap-10 w-full'>
          ...
          />
          <ClassRoutineSearchFormSelector />
        </div>
...
export default ClassRoutineSearchForm;
