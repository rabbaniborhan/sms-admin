...
import StudentAdmitCardList from "./StudentAdmitCardList/StudentAdmitCardList";
import StudentAdmitCardSearchForm from "./StudentAdmitCardSearchForm/StudentAdmitCardSearchForm";

const StudentAdmitCardListPage = () => {
  return (
    <div className='w-11/12 mx-auto mt-10 pb-32'>
      ...
      <StudentAdmitCardSearchForm />
      <StudentAdmitCardList />
    </div>
  );
};

export default StudentAdmitCardListPage;
