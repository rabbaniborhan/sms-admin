...
const CreateRunningNoticeForm = ({ setShowModal }) => {
  return (
    <div className="w-[500px] h-[325px] bg-white rounded relative">
      ...
      <form className="px-5">
        <div className="flex justify-center items-center gap-8">
          <div className="flex flex-col justify-start items-start gap-[31px]">
            ...
            <label htmlFor="">Upload Icon</label>
          </div>
          ...
          <div className="flex flex-col justify-center items-center gap-5">
            ...
            <label
              htmlFor="file"
              className="file w-72 ring-1 ring-gray-400 outline-none flex justify-start items-start gap-1 rounded"
            >
...
export default CreateRunningNoticeForm;
